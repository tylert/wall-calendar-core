...
print(
    f'S^ {s.days * 5/7:.2f} workdays, {s.days} days, {s.days / 7:.2f} weeks, {s.days / 30:.2f} months, {s.days / 365:.2f} years'
)
...
print(
    f'Bv {b.days * 5/7:.2f} workdays, {b.days} days, {b.days / 7:.2f} weeks, {b.days / 30:.2f} months, {b.days / 365:.2f} years'
)
...
print(f'Av {a.days * 5/7:.2f} workdays, {a.days} days, {a.days / 7:.2f} weeks, {a.days / 30:.2f} months, {a.days / 365:.2f} years')
